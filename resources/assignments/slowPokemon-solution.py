...
def main():
    ...
    while p1_choice not in possible_classes:
        p1_choice = input("Try again. Select your pokemon (Pikachu, Bulbasaur, Squirtle, Charmander): ").capitalize()
    ...
    while p2_choice not in possible_classes:
        p2_choice = input("Try again. Select your pokemon (Pikachu, Bulbasaur, Squirtle, Charmander): ").capitalize()
